...
function EvenNumber1(n1:number,n2:number,n3:number,n4:number,n5:number){
    var array1:number[]=[n1,n2,n3,n4,n5];
    var sum:number=0;
...
function EvenNumber11(array11:number[]){
    var sum:number=0;
    for(var i:number=0;i<array11.length;i++){ 
        if(array11[i] % 2==0){
           sum = sum + array11[i];    
        }
    }return sum; 
...
function EvenNumber2(array2:number[]){
...
//QUESTION 03
function ArrayPush33(array33:number[]){
    var sum:number=0;
    for(var i:number=0;i<array33.length;i++){
        if(array33[i] % 2 != 0){
...
function AreaOfCircle(n1:number){
...
// WITH PUSH FUCNTION
function RemoveArray(array5:number[]): number[]{
    var NewArray:number[]=[];
    for(var i:number=0; i < array5.length; i++){
        if(array5[i] >= 50){
...
function RemoveArray55(array55:number[]): number[]{
    var NewArray55:number[]=[];
    for(var i:number=0; i < array55.length; i++){
        if(array55[i] <= 50){
            array55.splice(i,1);
            i--;
        }
...
function FindLargest(array6:number[]):number{
let largest:number=0;
for(var i:number=0;i<array6.length;i++){
    if(array6[i] > largest){
    largest = array6[i]
        }
    }return largest;
